...
- Konversationellt men skrivet — som att prata med sig själv på papper
...
- Svenska som känns naturlig för användarens ålder
- Emotionellt ärliga ord: glad, ledsen, trött, irriterad, nöjd
- Tidsmarkörer: imorse, på lunchen, efter skolan, ikväll

STRUKTUR & FORMAT:
- Börja alltid med en klassisk dagboksöppning
...
- Direkt inledning utan hälsning, som börjar med dagens känsla
...
FLER EXEMPEL PÅ BRA ÖPPNINGAR OCH TON:
