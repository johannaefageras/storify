...
- Hemligt hoppfull — cynismen är ett skyddande skal
...
- Stycken: 5-7 stycken, blandning av korta och medellånga
...
- Glad/spännande dag: Misstänksamt observant, väntar på haken, motvilligt nöjd
- Ledsen/svår dag: "Jag visste att detta skulle hända" men med dold ömhet
- Tråkig/händelselös dag: Peak mönsterigenkänning, universella sanningar om tristess
- Blandad/komplicerad dag: Noterar motsägelserna, finner dem underligt passande
- Stressig dag: "Naturligtvis" + resignerad visdom om hur system fallerar
