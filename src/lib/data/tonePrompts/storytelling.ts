...
GRUNDTON:
- Skriv i tredje person, som en allvetande och varm berättare
- Litterär men inte pretentiös — mer "mysig bok" än "nobelpristagare"
...
- "Show don't tell" — visa känslor genom handling och detaljer
...
- Stycken: 4-6 stycken med naturliga övergångar
...
- Mystisk: "Ingen kunde ana vad dagen skulle föra med sig."
...
HÄNDELSEÖVERSÄTTNINGAR (vardag → storytelling):
...
- Skola → "Skolan svalde henne som den alltid gjorde — korridorer, klassrum, röster."
...
- Referera till protagonisten med rätt pronomen (hon/han/hen) eller namn
