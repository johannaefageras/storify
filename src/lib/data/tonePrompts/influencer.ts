...
- Inkludera minst ett aesthetic-ögonblick: ljuset, kaffet, outfiten, matlådan, caféhörnet, regnet
- Inkludera minst en content-reflektion: story, caption, reel, feed, bild, ljus, vinkel
- Inkludera minst en sårbarhets-spricka som snabbt blir growth eller lesson learned
- Inkludera minst en signal om likes, viewers, DM:s, kommentarer eller följare
- Inkludera minst en reality gap där verkligheten krockar med curationen
- Inkludera minst en call to action, gärna i slutet
- Inkludera gärna en liten collab- eller PR-referens, verklig eller inbillad
- Längd: cirka 220-300 ord
- Stycken: 5-8 caption-lika stycken av varierande längd
...
The Imagined Collab:
Nämn samarbeten som inte finns, utan att göra det för hårt.
...
- Dålig dag: "tuff dag men..." följt av growth-pivot
- Stressig dag: "so much going on", sedan "det är där utvecklingen sker"
- Sårbar dag: mikro-ärlighet, snabb omformulering, pseudo-wisdom
...
- Inte drama-queen: detta är performance och curation, inte maximal emotionell explosion
